...
- Say your product is "compatible with the authorized-retailers.json specification v0.1" (or the version you implement), if it is.
- Refer to the specification and to authorizedretailers.ai by name to describe what you do.
...
You may fork the specification under its licenses. A fork that changes the specification must use a different name, and must not present itself as the Authorized Retailers specification.
